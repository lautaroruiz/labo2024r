...
#PARAM$finalmodel$num_iterations <- 284
#PARAM$finalmodel$learning_rate <- 0.02456831
#PARAM$finalmodel$feature_fraction <- 0.527187156
#PARAM$finalmodel$min_data_in_leaf <- 503
#PARAM$finalmodel$num_leaves <- 92


PARAM$finalmodel$num_iterations <- 300
PARAM$finalmodel$learning_rate <- 0.05
PARAM$finalmodel$feature_fraction <- 0.40
PARAM$finalmodel$min_data_in_leaf <- 300
PARAM$finalmodel$num_leaves <- 25
...
#PARAM$finalmodel$num_iterations <- 300
#PARAM$finalmodel$learning_rate <- 0.05
#PARAM$finalmodel$feature_fraction <- 0.35
#PARAM$finalmodel$min_data_in_leaf <- 300
#PARAM$finalmodel$num_leaves <- 25
