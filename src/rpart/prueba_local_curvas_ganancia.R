...
PARAM$minsplit <- 50
PARAM$minbucket <- 25
PARAM$maxdepth <- 20 #20

# 8000 - 4000 - 3
# 100 - 20 - 3 para ambas train y test quedan juntas

# 100 - 20 - 20 # se separa mas train y test
# 8000 - 4000 - 30 # se juntan un poco pero entiendo que queda simple el arbol (poca profundidad)
# 
...
ksemilla_azar <- 100019#tabla_semillas[ 1, semilla ]  # 1 es mi primera semilla
