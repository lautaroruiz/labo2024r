...
# Asociado con los archivos EV 1 a 5
...
wf_julio <- function( pnombrewf, metodo_dr )
{
...
metodos_dr <- c("ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "estandarizar")
lapply(metodos_dr, function(metodo) wf_julio(metodo_dr = metodo))
#for (metodo_dr %in% c("ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "estandarizar")){
#  wf_julio(metodo_dr = metodo_dr)}
