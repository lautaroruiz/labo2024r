...
# Asociado con los archivos de EV 7
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_007.r"

  # valores posibles
  #  "ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "estandarizar", "uva"
  param_local$metodo <- metodo
  param_local$semilla <- NULL  # no usa semilla, es deterministico
