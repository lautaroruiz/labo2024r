...
envg$EXPENV$arch_sem <- "mis_semillas_008.txt"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_008.r"
...
metodos_dr <- c("rank_simple", "rank_cero_fijo", "deflacion", "estandarizar")
