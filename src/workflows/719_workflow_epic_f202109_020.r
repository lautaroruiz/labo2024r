...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(201903,201904,201907,201908,201911,202001,202011,202012,202103,202104,202105,202106,202107) 

  param_local$train$training <- c(201901,201902,201905,201906,201909,202010,202101,202102,202103,202105)
  param_local$train$validation <- c(202106,202012,201910)
