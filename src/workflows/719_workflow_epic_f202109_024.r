...
# Pao 005
# Pero desconsidero las bases 201910, 202105
# copia 21 pero con deflacion
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.6
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  #param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102,
  #  202101, 202012, 202011)
  param_local$final_train$training <- c(201903,201904,201907,201908,201911,202011,202012,202103,202104,202106,202107) 
  ...
  param_local$train$validation <- c(202106,202103)
  param_local$train$testing <- c(202107,202104)
